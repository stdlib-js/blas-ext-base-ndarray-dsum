...
var dsum = tryRequire( resolve( __dirname, './../lib/native.js' ) );
var opts = {
...
tape( 'the function has an arity of 1', opts, function test( t ) {
	t.strictEqual( dsum.length, 1, 'has expected arity' );
	t.end();
});
